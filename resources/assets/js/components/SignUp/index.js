...
SignUp.propTypes = {
  ...
  SignUp.onNameChange = (e) => {
    this.setState({
      name: e.target.value
    });
  }

  SignUp.onUsernameChange = (e) => {
    this.setState({
      username: e.target.value
    });
  }

  SignUp.onEmailChange = (e) => {
    this.setState({
      email: e.target.value
    });
  }

  SignUp.onPhoneChange = (e) => {
    this.setState({
      phone: e.target.value
    });
  }

  SignUp.onBirthDateChange = (e) => {
    this.setState({
      birth_date: e.target.value
    });
  }

  SignUp.onPasswordChange = (e) => {
    this.setState({
      password: e.target.value
    });
  }

  SignUp.onPasswordConfirmationChange = (e) => {
    this.setState({
